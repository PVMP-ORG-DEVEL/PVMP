	...
	public static void displayRegisterError(EditText et1, EditText et2, EditText et3,
	    ...
	    switch (validationResult) {
			...
			case 2:
				...
				break;
			case 3:
				ErrorHandlingUtil.genericError(et3, "Nome inválido.", context);
				break;
			case 4:
			...
			case 5:
				...
				break;
			case 6:
				ErrorHandlingUtil.genericError(et2, "Formato de email inválido.", context);
				break;
			case 7:
				ErrorHandlingUtil.genericError(et2, "Seu email deve ter, no máximo, 40 caracteres.", context);
				break;
			case 8:
